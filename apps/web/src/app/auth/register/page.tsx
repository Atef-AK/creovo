...
export default function RegisterPage() {
    ...
    const { signUpWithEmail, signInWithGoogle, isLoading, error } = useAuthStore();
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 shadow-lg">
                    ...
                    <div className="text-center mb-6">
                        <span className="inline-block px-4 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-sm font-medium rounded-full">
